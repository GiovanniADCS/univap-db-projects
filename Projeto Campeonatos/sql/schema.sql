-- ============================================================
-- schema.sql
-- Banco de dados simples para campeonatos esportivos
-- MySQL
-- ============================================================
...
CREATE TABLE Campeonato_Temporada (
    id_campeonato_temporada INT AUTO_INCREMENT,
    id_campeonato INT NOT NULL,
    id_temporada INT NOT NULL,
    nome_edicao VARCHAR(120) NOT NULL,
    data_inicio DATE NOT NULL,
    data_fim DATE NOT NULL,
    situacao VARCHAR(30) NOT NULL,
    PRIMARY KEY (id_campeonato_temporada),
...
CREATE TABLE Equipe_Campeonato (
    ...
    id_campeonato_temporada INT NOT NULL,
    grupo VARCHAR(20),
    ...
    FOREIGN KEY (id_campeonato_temporada) REFERENCES Campeonato_Temporada (id_campeonato_temporada)
);
